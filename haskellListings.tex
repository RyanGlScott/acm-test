...
%           {Inarritu}{I$\tilde{\text{n}}\acute{\text{a}}$rritu}8,
	...
	{[2]Show,Eq,Iso,VerifiedOrd,Ord,Num,UpClosed,Comp,Wit,Witness,Inductive,Meet,Flip,TRUE,
        ...
        UniqList,BST,MinHeap,MaxHeap,World,RIO,IO,HIO,Post,Pre,Type,So,T,
        Privilege, Prop, Chain, ChainTy, Range, Dict, RD, Dom, Set, P, Univ, Schema, MovieSchema, RT,
        TDom, TRange, MoviesTable, RTSubEqFlds, RTEqFlds, Disjoint, Union, Ret, Seq, Trans, SBool, Sing, VEq, VOrd, GOrd, Generic, Rep, VGeneric, U1, K1,
        AbelianSemigroup, Alternative, Applicative, Functor, Monad, MonadPlus, MonadZip, Semigroup, Traversable,
        Identity, GApplicative, VApplicative, Generic1, VGeneric1, VSemigroup, SumEx, ProductEx, Unit, Pair,
        V1, M1, Par1, Rec1, VTraversable, ReverseLexicoOrd,
...
% 	{[5]
% 		EQ,GT,LT,Left,Right
% 		, False, True, Just, Nothing, Oh, MkT
% 	},
